...
//******************************************************************************************************************
_watchdogspeedentry::_watchdogspeedentry(_watchdogspeed*w,_tg v):_basis::_listenknoten<_watchdogspeedentry>(&w->fpslist){
				value=v;
				watchdogspeed=w;
};
...
//******************************************************************************************************************
_watchdogspeed::__watchdogspeed(){
...
//******************************************************************************************************************
_statusbarentry::_statusbarentry(_solitaire*s,_zeichenkette<char>&t,_tg o=1,_tg dt=2000):_basis::_listenknoten<_statusbarentry>(&s->statusbarlist){
				solitaire=s;
				text=t;
				opacity=o;
				duration=true;
...
void _pileinfoentry::draw(_grafik*gra,_kamera<_tg>*cam){
				...
				drawguitext(gra,h,solitaire->fopnt18,o,c);
				//SetImageFont(solitaire->font16)
				h=desc0;
...
_solitaire::_solitaire(){
				...
				campreview->position.setzen(0,0,-33);
				campreview->view.setzen(0,0,2);
				campreview->up.setzen(0,0.8,0);
				campreview->side.setzen(1,0,0);
				
				cammenu=new _camerasolitaire();
				cammenu->position.setzen(0,0,-33);
				cammenu->view.setzen(0,0,2);
				cammenu->up.setzen(0,0.8,0);
				cammenu->side.setzen(1,0,0);
...
_liste<_zeichenkette<_tt>*_solitaire::textsplit(const _zeichenkette<char>&t,_tg wx,_zeichensatz*f){
...
//------------------------------------------------ old effects -------------------------------------------------------------				
_candle*_solitaire::createcandle(_liste<_candle>*l,_tg x,_tg y,_tg z,_tg i,_tg sc,_tg sp,_liste<_partikel>*pl){
				_candle*c0;
				bool im=false;
